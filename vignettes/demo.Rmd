...
processed_data = data %>% 
  ...
  add_activity_profile(group_col = group, activity_col = Xt)
```
...
start = Sys.time()
el = data %>% EL_test(group_col = group, activity_col = Xt)
end = Sys.time()
